...
public class Main {
    ...
    private static void arrayStore() throws Exception {
        ...
        try {
            ...
            assertEquals("Incompatible types: src=float[], dst=java.lang.Runnable[]",
                         ex.getMessage());
        }
    ...
    private static void nullPointers() throws Exception {
        ...
        try {
            ...
            assertEquals("Attempt to invoke virtual method 'int java.lang.Object.hashCode()' on " +
        ...
        try {
            ...
            assertEquals("Attempt to read from field 'int A.i' on a null object reference in " +
                                 "method 'void Main.nullPointers()'",
                         ex.getMessage());
        }
        ...
        try {
            ...
            assertEquals("Attempt to write to field 'int A.i' on a null object reference in " +
                                 "method 'void Main.nullPointers()'",
                         ex.getMessage());
        }
    ...
    private static void reflection() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    "method java.lang.String.charAt argument 1 has type int, got java.lang.String",
                    iae.getMessage());
        }
        try {
            Method m = String.class.getMethod("charAt", int.class);
