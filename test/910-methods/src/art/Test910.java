...
public class Test910 {
    ...
    public static void doTest() throws Exception {
        ...
        // Find a synthetic method in the placeholder inner class. Do not print the name. Javac
        // and Jack disagree on the naming of synthetic accessors.
        //
    ...
    private static void testMethod(Method m, Class<?> base, boolean printAll) {
        ...
        if (modifiers != m.getModifiers()) {
            throw new RuntimeException(
                    "Modifiers not equal: " + m.getModifiers() + " vs " + modifiers);
        }
        if (printAll) {
