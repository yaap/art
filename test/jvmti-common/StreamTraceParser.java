...
public class StreamTraceParser extends BaseTraceParser {
    public void CheckTraceFileFormat(File file, int expectedVersion, String threadName,
                                     String methodNameFilter) throws Exception {
        ...
        while (hasEntries) {
            ...
            if (threadId != 0) {
                String eventString = ProcessEventEntry(threadId, methodNameFilter);
